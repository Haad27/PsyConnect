...
Command: npx gltfjsx@6.5.3 dining_room_kichen_baked.glb 
*/
...
export function Room2(props) {
  const { nodes, materials } = useGLTF('/models/dining_room_kichen_baked.glb')
  return (
    <group {...props} dispose={null}>
      <group scale={0.01}>
        ...
        <mesh geometry={nodes.IKEA_seat_wood__0.geometry} material={materials.wood_} position={[363.595, 31.995, -331.439]} rotation={[-Math.PI / 2, 0, -Math.PI / 2]} scale={[17.536, 15.514, 15.514]} />
        <mesh geometry={nodes.carpet_Carpet__0.geometry} material={materials.Carpet_} position={[81.578, 2.411, 26.536]} rotation={[-Math.PI / 2, 0, 0]} scale={[190.768, 245.015, 0.524]} />
...
useGLTF.preload('/models/dining_room_kichen_baked.glb')
